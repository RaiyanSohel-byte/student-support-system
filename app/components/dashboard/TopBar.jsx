      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 pr-6 border-r border-slate-100">
          ...
          <div className="relative">
            ...
            {/* Notification Badge */}
            <div className="absolute -top-1 -right-1 w-5 h-5 bg-orange-500 border-2 border-white rounded-full flex items-center justify-center text-[10px] text-white font-bold">
              1
            </div>
          </div>
        </div>
